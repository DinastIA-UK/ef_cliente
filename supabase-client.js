...
const supabaseKey = process.env.SUPABASE_SERVICE_KEY || process.env.SUPABASE_ANON_KEY; // Tentar SERVICE_KEY primeiro, depois ANON_KEY

if (!supabaseUrl || !supabaseKey) {
    throw new Error('Variáveis de ambiente SUPABASE_URL e (SUPABASE_SERVICE_KEY ou SUPABASE_ANON_KEY) são obrigatórias');
}
